...
@Component({
  ...
  template: `
    <div class="flex flex-column justify-content-center align-items-center h-30rem mt-5">
      <svg
        id="mainImage_create"
        data-name="mainImage"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 171.2 63">
        <path
          id="c-1"
        ...
        <polygon
          class="earMove"
          points="92.59 32.22 92.59 28.5 76.77 27.71 76.77 32.22 92.59 32.22"></polygon>
        ...
        <polygon
          ...
          style="fill: rgb(48, 81, 143);"></polygon>
        <circle
        ...
        <polygon
          class="cls-5"
          points="90.92 30.25 77.46 29.69 77.46 28.64 90.92 29.22 90.92 30.25"></polygon>
      </svg>
      <p class="text-2xl">No se encontraron resultados</p>
      <p-button label="Volver al explorador" [routerLink]="'/' + routesPath.LANDING_BROWSER" />
    </div>
  `,
  styleUrls: ['./not-found-results.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class NotFoundResultsComponent {
